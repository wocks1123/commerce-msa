...
|---|---|---|---|
| meta.eventType | string | yes | `OrderAbortedEvent` |
...
{
  "meta": {
    "eventId": "evt-order-aborted-001",
    "eventType": "OrderAbortedEvent",
